...
;        Note: the NMI and RESET vectors are always set up in NOICE_INIT
...
;  See if this is an illegal op-code trap or a reset
	...
	JR	Z,NOICE_INIT	;JIF RESET (AF on stack, but SP will be reloaded)
;
